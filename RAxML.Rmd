...
For example, Silva has an fast and easy web-based alignment tool (<https://www.arb-silva.de/aligner/>).
For larger jobs, sequences can be aligned in mothur on the cluster. 
...
After unzipping, rename the program "muscle".
